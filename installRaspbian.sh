...
source $APWD/distros/debian10/preinstallcheck.sh
source $APWD/distros/debian10/askquestions.sh

source $APWD/distros/debian10/install_basics.sh
source $APWD/distros/debian10/install_postfix.sh
source $APWD/distros/debian10/install_mysql.sh
source $APWD/distros/debian10/install_mta.sh
source $APWD/distros/debian10/install_antivirus.sh
source $APWD/distros/debian10/install_webserver.sh
source $APWD/distros/debian10/install_hhvm.sh
source $APWD/distros/debian10/install_ftp.sh
source $APWD/distros/debian10/install_quota.sh
source $APWD/distros/debian10/install_bind.sh
source $APWD/distros/debian10/install_webstats.sh
source $APWD/distros/debian10/install_jailkit.sh
source $APWD/distros/debian10/install_fail2ban.sh
source $APWD/distros/debian10/install_webmail.sh
source $APWD/distros/debian10/install_ispconfig.sh
source $APWD/distros/debian10/install_fix.sh

source $APWD/distros/debian10/install_basephp.sh #to remove in feature release
#---------------------------------------------------------------------
# Main program [ main() ]
#	Run the installer
#---------------------------------------------------------------------
